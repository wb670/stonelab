<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ProductAdd.aspx.cs" Inherits="ProductAdd" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" name="" value="" class="m_delete" onclick="$(this).parent().parent().remove();return false" />
                </td>
            </tr>
    ...
    <div>
        ...
        <div class="gt-right-col">
            <asp:Button ID="btnAdd" runat="server" Text="" CssClass="m_btn_do" OnClick="btnAdd_Click" />
