package {
    ...
    public class SWFUpload extends Sprite {
        ...
        private var crossdomainURL:String;
        ...
        public function SWFUpload() {
            ...
            // Allow crossdomain
            this.crossdomainURL = root.loaderInfo.parameters.crossdomainURL;
            if(this.crossdomainURL != null && this.crossdomainURL != "") {
                Security.loadPolicyFile(this.crossdomainURL);
            }
